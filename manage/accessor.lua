...
M.get_general_machines_in_categories = prototype_acc.get_general_machines_in_categories
M.get_machines_in_resource_category = prototype_acc.get_machines_in_resource_category
M.fluid_has_offshore_tile = prototype_acc.fluid_has_offshore_tile
M.get_offshore_filter_only_fluids = prototype_acc.get_offshore_filter_only_fluids
...
M.try_get_fluid_spent_fluid = energy_acc.try_get_fluid_spent_fluid
M.try_get_spent_fluid = energy_acc.try_get_spent_fluid
