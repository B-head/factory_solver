...
-- Set the repo-root search path and stub the one Factorio module the pure path
-- touches (__flib__/format). Shared with tests/solve_problem.lua so the two
-- headless hosts can't drift. Must run before any solver/manage require.
